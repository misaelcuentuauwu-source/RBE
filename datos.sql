...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2025 at 07:56 PM
...
--
-- Truncate table before insert `asiento`
--
...
--
-- Truncate table before insert `autobus`
--

TRUNCATE TABLE `autobus`;
--
...
--
-- Truncate table before insert `edo_viaje`
--

TRUNCATE TABLE `edo_viaje`;
--
...
--
-- Truncate table before insert `modelo`
--
...
--
-- Truncate table before insert `pasajero`
--
...
--
-- Truncate table before insert `taquillero`
--

TRUNCATE TABLE `taquillero`;
--
...
--
-- Truncate table before insert `terminal`
--
...
--
-- Truncate table before insert `tipo_asiento`
--

TRUNCATE TABLE `tipo_asiento`;
--
...
--
-- Truncate table before insert `tipo_pago`
--
...
--
-- Truncate table before insert `tipo_pasajero`
--

TRUNCATE TABLE `tipo_pasajero`;
--
...
--
-- Truncate table before insert `viaje`
--
...
--
-- Truncate table before insert `viaje_asiento`
--

TRUNCATE TABLE `viaje_asiento`;
--
